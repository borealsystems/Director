...
class SystemStatus extends Component {
  ...
  render () {
    if (this.state.status === 'info') {
      return (
        <div className="flex h-64 bg-teal-300 mb-2">
          <div className="w-16 bg-teal-400">
            <div className="p-4">
      ...
      return (
        <div className="flex h-64 bg-green-300 mb-2">
      ...
      return (
        <div className="flex h-64 bg-yellow-300 mb-2">
      ...
      return (
        <div className="flex h-64 bg-red-300 mb-2">
