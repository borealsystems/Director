...
class Alert extends Component {
  render () {
    if (this.props.type === 'info') {
      return (
        <div className="flex bg-teal-400 max-w-sm mb-4">
      ...
      return (
        <div className="flex bg-green-400 max-w-sm mb-4">
      ...
      return (
        <div className="flex bg-yellow-400 max-w-sm mb-4">
      ...
      return (
        <div className="flex bg-red-400 max-w-sm mb-4">
