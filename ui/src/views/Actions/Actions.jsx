...
const Actions = () => {
  ...
  const toggleNewActionVisability = () => {
    ...
    console.log(newActionVisability)
  }
        ...
        <div className="bg-gray-400 dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-center font-bold border border-gray-500 rounded-b-lg">
          <div>
            ...
            <div className="inline-block w-1/6 ">
              <button className="w-full bg-teal-500 py-2 px-2 h-10 font-bold rounded-br-lg border-l border-r border-gray-500" onClick={() => { toggleNewActionVisability() }}>New</button>
            </div>
          </div>
        </div>
      }
