...
class SystemStatus extends Component {
  ...
  render () {
    if (this.state.status === 'info') {
      return (
        <div className="flex h-64 bg-teal-900 mb-2">
          <div className="w-16 bg-teal-600">
            <div className="p-4">
      ...
      return (
        <div className="flex h-64 bg-gray-900 mb-2">
          <div className="w-16 bg-green-800">
            <div className="p-4">
      ...
      return (
        <div className="flex h-64 bg-yellow-900 mb-2">
      ...
      return (
        <div className="flex h-64 bg-red-900 mb-2">
