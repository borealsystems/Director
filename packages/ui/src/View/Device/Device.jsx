...
import { Button, ButtonSet, ComboBox, TextInput, Form, FormGroup, ProgressIndicator, ProgressStep, Grid, Row, Column, DropdownSkeleton, InlineLoading, InlineNotification } from 'carbon-components-react'
...
const Device = ({ match: { params: { id } } }) => {
  const isNew = id === 'new'
  const initialDevice = isNew ? {} : {}
